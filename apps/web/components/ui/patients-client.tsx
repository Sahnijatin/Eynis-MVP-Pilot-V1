...
const STATUS_META: Record<string, { label: string; color: string; bg: string }> = {
  active: { label: "Active", color: "var(--ok-text)", bg: "#d1fae5" },
  due: { label: "Due", color: "var(--warn-text)", bg: "#fef3c7" },
  overdue: { label: "Overdue", color: "var(--danger-text)", bg: "#fee2e2" },
  lost_follow_up: { label: "Lost Follow-up", color: "var(--text-muted)", bg: "#f1f5f9" },
};
