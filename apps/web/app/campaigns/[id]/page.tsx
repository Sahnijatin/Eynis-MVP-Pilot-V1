  ...
  try {
    ...
    return (
      <div className="max-w-lg mx-auto mt-16 text-center">
        <h1 className="text-lg font-semibold text-slate-800 mb-2">Couldn&apos;t load this campaign</h1>
        <p className="text-sm text-slate-500 mb-4">The service didn&apos;t respond in time. Your data is safe — try again.</p>
