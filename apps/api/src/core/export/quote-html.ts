...
<style>
  ...
  *{ box-sizing:border-box; -webkit-print-color-adjust:exact; print-color-adjust:exact; }
  ...
  body{ font-family:var(--sans); color:var(--ink); font-size:14px; line-height:1.4; -webkit-font-smoothing:antialiased; }
  ...
  .brand h1{ margin:0; font-family:var(--serif); font-weight:700; font-size:28px; letter-spacing:.01em; color:var(--accent); line-height:1.05; }
  .seller-lines{ margin-top:7px; display:grid; gap:2px; font-size:13.5px; color:var(--muted); }
  .seller-lines .k{ color:var(--ink); font-weight:600; }
  .doc-title{ font-family:var(--serif); font-size:29px; letter-spacing:.14em; color:var(--ink); margin:0 0 10px; font-weight:700; }
  .meta{ display:grid; grid-template-columns:auto 1fr; gap:5px 12px; font-size:13.5px; margin:0; }
  ...
  .banner{ background:linear-gradient(180deg,var(--accent),var(--accent-d)); color:var(--on-accent);
    border-radius:5px; padding:6px 12px; font-size:13px; letter-spacing:.16em; text-transform:uppercase; font-weight:650; }
  .billto{ margin-top:9px; }
  .billto .who{ margin-top:5px; font-size:16px; font-weight:700; }
  .billto .lines{ margin-top:3px; font-size:13.5px; color:var(--muted); }
  .sep{ color:var(--hair); margin:0 8px; }

  .items{ margin-top:9px; }
  table{ width:100%; border-collapse:collapse; margin-top:6px; border:1px solid var(--hair); border-radius:6px; overflow:hidden; font-size:14px; }
  ...
  tbody td{ padding:5px 11px; border-bottom:1px solid var(--hair-2); vertical-align:top; text-align:right; font-variant-numeric:tabular-nums; }
  tbody td.l{ text-align:left; }
  tbody tr:last-child td{ border-bottom:none; }
  tr{ break-inside:avoid; }
  .piece{ font-weight:700; font-size:14.5px; }
  .sub{ color:var(--muted); font-size:13px; margin-top:2px; }
  .u{ color:var(--muted); }
  .hsn{ display:inline-block; font-variant-numeric:tabular-nums; background:var(--panel); border:1px solid var(--hair);
    border-radius:4px; padding:0 5px; color:var(--ink); font-size:12.5px; }
  ...
  .subtotal-bar{ display:grid; grid-template-columns:1fr auto auto; gap:18px; align-items:center; margin-top:6px;
    padding:7px 13px; border-radius:6px; background:linear-gradient(180deg,var(--accent),var(--accent-d));
    color:var(--on-accent); font-size:14.5px; font-weight:650; font-variant-numeric:tabular-nums; break-inside:avoid; }
  .subtotal-bar .lbl{ letter-spacing:.12em; text-transform:uppercase; font-size:13px; }
  .note{ margin-top:4px; font-size:12px; color:var(--faint); font-style:italic; }
  ...
  .foot{ margin-top:9px; display:grid; grid-template-columns:1fr .82fr; gap:26px; }
  .foot h3{ margin:0 0 5px; font-size:13px; letter-spacing:.13em; text-transform:uppercase; color:var(--ink); }
  .block + .block{ margin-top:9px; }
  .kv{ font-size:13.5px; color:var(--muted); line-height:1.5; }
  .kv b{ color:var(--ink); font-weight:600; }
  .terms{ margin:0; padding:0; list-style:none; font-size:13px; color:var(--muted); line-height:1.4; }
  .terms li{ position:relative; padding-left:15px; margin-bottom:2px; }
  ...
  .summary .row .on{ color:var(--faint); font-size:12.5px; }
  ...
  .summary .grand .lab{ font-family:var(--serif); font-size:15.5px; font-weight:700; }
  .summary .grand .val{ font-family:var(--serif); font-size:20px; font-weight:700; color:var(--accent); }
  .summary .words{ margin-top:5px; font-size:12.5px; color:var(--muted); font-style:italic; text-align:right; }

  .signs{ margin-top:11px; display:grid; grid-template-columns:1fr 1fr; gap:26px; align-items:end; break-inside:avoid; }
  .sign .line{ border-top:1px solid var(--hair); padding-top:6px; font-size:13px; color:var(--muted); }
  .sign.right{ text-align:right; }
  .sign.right .for{ font-size:13px; color:var(--muted); }
  .sign.right .co{ font-family:var(--serif); font-weight:700; font-size:15px; color:var(--ink); margin-top:2px; letter-spacing:.04em; }
  .footer-mark{ margin-top:8px; padding-top:8px; border-top:1px solid var(--hair-2); display:flex; justify-content:space-between;
