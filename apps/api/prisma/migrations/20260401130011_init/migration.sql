...
CREATE TABLE "ServiceRequestTransition" (
    ...
    CONSTRAINT "ServiceRequestTransition_hotelId_fkey" FOREIGN KEY ("hotelId") REFERENCES "Hotel" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "ServiceRequestTransition_serviceRequestId_fkey" FOREIGN KEY ("serviceRequestId") REFERENCES "ServiceRequest" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "ServiceRequestTransition_changedByUserId_fkey" FOREIGN KEY ("changedByUserId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
INSERT INTO "new_ServiceRequest" ("category", "createdAt", "guestId", "hotelId", "id", "resolvedAt", "source", "status", "summary", "updatedAt") SELECT "category", "createdAt", "guestId", "hotelId", "id", "resolvedAt", "source", "status", "summary", "updatedAt" FROM "ServiceRequest";
